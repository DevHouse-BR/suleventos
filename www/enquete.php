				...
				<tr>
					<td width="100%" align="left" valign="top">
						...
						if ($vazio) echo('<br><br><span class="menu">Nenhuma Enquete Criada</span>');
							...
							<table border="0">
								<tr>
									<td colspan="2" class="menu"><?=$enquete["pergunta"]?></td>
								</tr>
								<form action="enquete.php" method="post">
								<?
								if (strlen($enquete["opcao1"]) != 0) echo('<tr><td width="10%"><input type="radio" name="opcao" value="1"></td><td class="menu" style="font-weight: normal;">' . $enquete["opcao1"] . '</td></tr>');
								if (strlen($enquete["opcao2"]) != 0) echo('<tr><td width="10%"><input type="radio" name="opcao" value="2"></td><td class="menu" style="font-weight: normal;">' . $enquete["opcao2"] . '</td></tr>');
								if (strlen($enquete["opcao3"]) != 0) echo('<tr><td width="10%"><input type="radio" name="opcao" value="3"></td><td class="menu" style="font-weight: normal;">' . $enquete["opcao3"] . '</td></tr>');
								if (strlen($enquete["opcao4"]) != 0) echo('<tr><td width="10%"><input type="radio" name="opcao" value="4"></td><td class="menu" style="font-weight: normal;">' . $enquete["opcao4"] . '</td></tr>');
								?>
								<tr>
